...
function Flatpickr(element, config) {
	...
	function positionCalendar() {
		...
		var top = void 0,
		    left = window.pageXOffset + inputBounds.left-309;

		if (distanceFromBottom < calendarHeight) {
			top = window.pageYOffset - calendarHeight + inputBounds.top -25;
			self.calendarContainer.classList.remove("arrowTop");
			self.calendarContainer.classList.add("arrowBottom");
		} else {
			top = window.pageYOffset + input.offsetHeight + inputBounds.top -25;
	...
	function setupFormats() {
		self.formats = {
			...
			z: function z(date) {
			    return Flatpickr.l10n.weekdays.zhhand[self.formats.w(date)];
			},
...
Flatpickr.l10n = {
	...
	months: {
		...
		//longhand: [ __tr("January"),__tr("February"), __tr("March"),__tr("April"), __tr("May"),__tr( "June"),__tr("July"),__tr("August"), __tr("September"), __tr("October"), __tr("November"), __tr("December")]
	},
...
Flatpickr.l10n.weekdays = {
	shorthand: ['_周日_', '_周一_', '_周二_', '_周三_', '_周四_', '_周五_', '_周六'],
	longhand: ['_星期日_', '_星期一_', '_星期二_', '_星期三_', '_星期四_', '_星期五_', '_星期六_']
};

Flatpickr.l10n.months = {
	shorthand: ['_一月_', '_二月_', '_三月_', '_四月_', '_五月_', '_六月_', '_七月_', '_八月_', '_九月_', '_十月_', '_十一月_', '_十二月_'],
	longhand: ['_一月_', '_二月_', '_三月_', '_四月_', '_五月_', '_六月_', '_七月_', '_八月_', '_九月_', '_十月_', '_十一月_', '_十二月_']
};

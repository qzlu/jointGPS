<template>
	<section style="height: 100%">
		...
		<div id="operate_wrapper">
			<div class="box-header">
				...
				<div class="block">
					...
					<el-date-picker v-model="value2" size="small" align="right" :clearable="false" @change="getTime" type="date" placeholder="_选择日期_"
		...
		<div class="el_table_wrap" id="el_table_wrap" style="position: relative">
			<el-table :data="table" v-loading="loading" element-loading-text="_拼命加载中_" empty-text="_暂无数据_" stripe :height="table_height"
			 style="width:100%">
				<el-table-column type="index" align="center" label="_序号_" width="80">
				</el-table-column>
				<el-table-column prop="FGPSDateTime" label="_最后更新时间_" align="center" width="180">
				</el-table-column>
				<el-table-column min-width="1000" header-align="center" align="left" :label="vehicleName">
			...
			<transition name="slide-fade" enter-active-class="bounce-enter-active" leave-active-class="bounce-leave-active">
			...
			<div class="mymodalCommon mymodal1" v-show="radio==1" :class="{'chartModal':!fullScreen,'fullScreen':fullScreen}">
				<div class="modal-header">
					<div style="float: right">
						<button type="button" @click="open" class="btn-white btn-custom" style="width: 95px">
							<i class="fa fa-arrows-alt  padding-r-8"></i>{{word}}
						</button>
						<button type="button" @click="closeMymodal" style="height: 20px;width: 20px;background:white;border: none;">
			...
			<div class="mymodalCommon mymodal2" :class="{'show':radio==2,'chartModal':!fullScreen1,'fullScreen':fullScreen1}">
				<div class="modal-header" style="margin-bottom: -40px;position: absolute;z-index: 11; right: 0px;">
					<div style="float: right">
						<button type="button" @click="open" class="btn-white btn-custom" style="width: 95px">
							<i class="fa fa-arrows-alt  padding-r-8"></i>{{word1}}
						</button>
						<button type="button" @click="closeMymodal" style="height: 20px;width: 20px;background:white;border: none;">
							<span class="glyphicon glyphicon-remove" style="font-size:14px;font-weight: normal;"></span>
						</button>

    ...
    <section>
        ...
        <div class="el_table_wrap" id="el_table_wrap"><!--part2 header start-->
            ...
            <el-table :data="switchLockCountInfo" stripe style="width: 100%" :height="table_height"
                ...
                <el-table-column prop="FAgentCompanyName" label="_公司名称_" show-overflow-tooltip sortable width="100">
                </el-table-column>
                <el-table-column prop="TripCount" label="_趟次数_" sortable width="130">
                </el-table-column>
            ...
            <el-table :data="allSwitchLockInfo" stripe style="width: 100%" :height="table_height" v-show="show_allSwitchLockInfo">
                ...
                <!--<el-table-column label="_操作_" align="center" width="100">-->
                    <!--<template scope="scope">-->
                        <!--<el-button type="text" title="_查看图片_" v-if="scope.row.FCargoPictures" size="small" @click="showPicture(scope.row)">_查看图片_</el-button>-->
                        <!--<el-button type="text" title="_查看图片_" disabled v-if="!scope.row.FCargoPictures" size="small" @click="showPicture(scope.row)">_查看图片_</el-button>-->
                    <!--</template>-->
                <!--</el-table-column>-->
                ...
                <!--</el-table-column>-->
                <el-table-column prop="FOpenType" label="_开锁方式_" width="140">
                </el-table-column>
                <el-table-column prop="FCardNo" label="_刷卡卡号_" width="140">
                </el-table-column>
                <el-table-column prop="FEndTime" label="_开锁时间_" sortable width="180">
                </el-table-column>
                <el-table-column prop="openAddress" align="center" show-overflow-tooltip label="_开锁地点_" width="230">
                </el-table-column>
                <el-table-column prop="FStartTime" align="center" label="_上锁时间_" width="180">
                </el-table-column>
                ...
                <el-table-column prop="FEndMileage" align="center" show-overflow-tooltip label="_开锁里程_(km)" width="120">
                </el-table-column>
                <!--<el-table-column prop="FDischargeCargo" align="center" show-overflow-tooltip label="_司机电话_" width="180">-->
                <!--</el-table-column>-->
    ...
    export default {
        ...
        methods: {
            ...
            doQuery(){
                ...
                if (this.FAssetGUIDs == "") {
                    this.warningDialogMsg("_请选择设备_!", "warning");
                    return false;
                }
                //FAssetGUIDs
                var _this = this;
            ...
            showPicture(row){
                if(row.FCargoPictures){
                    //console.log(row.FCargoPictures);
                    this.showPictureDialog=true;
                    this.pictureArr=row.FCargoPictures.split(",");
                }
            },
            //关闭modal窗口
            closeMymodal() {
            ...
            getUsableData(arr, type){
                ...
                for (let i = 0; i < result.length; i++) {
                    if(type=="collect"){
                        ...
                        result[i].FDeliveryTime = this.parseGMT(result[i].FDeliveryTime);
                        //解析地址
                        if (result[i].FStartLongitude != "" || result[i].FStartLatitude != undefined||result[i].FEndLongitude  != "" || result[i].FEndLatitude  != undefined) {
                            let pointObj1 = {lat: result[i].FEndLatitude, lng: result[i].FEndLongitude};
                            let point1 = this.parsePoint(this.$store.state.globalMapType, pointObj1);
                            let pointObj2 = {lat: result[i].FStartLatitude, lng: result[i].FStartLongitude};

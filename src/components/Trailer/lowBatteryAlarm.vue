  ...
  <section>
        ...
        <div class="modal-content" >
          ...
          <div class="modal-footer" style="margin-right: 10px">
            <div class="btn btn-primary btn-sm" style="height: 30px;padding: 0px">
              <button type="button" class="btn  btn-xs mybtn" data-dismiss="modal" @click="handle(0,6)" style="width: 40px">_提交_</button>
    ...
    <div id="operate_wrapper">
      <div class="box-header">
        ...
        <div class="btnList">
          <el-button type="primary" class="search" @click="queryCount(0,6)">_查询_</el-button>
          ...
          <el-button type="primary" class="read" @click="setToRead(0,6)"><i class="fa fa-envelope-open-o"></i>_设为已读_</el-button>
        </div>
      </div>
    </div>
        ...
        <div class="el_table_wrap" id="el_table_wrap">
          <el-table
            ...
            <el-table-column
              ...
              label="_操作_">
              <template scope="scope">
                <a href="javascript:" @click="addTab(scope.$index,scope.row,6)" v-if="scope.row.FAlarmCount!=0">_详情_</a>
        ...
        if ( FVehicleID!=undefined){
          ...
          if(arguments.length==0){
            ...
            $.ajax({
              ...
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":-1,"FPageSize":"'+_this.pageSize0+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
            ...
            $.ajax({
              ...
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":-1,"FPageSize":"'+_this.pageSize1+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
              success: function (data) {
                var fobj = data;
                console.log(data)
            ...
            $.ajax({
              ...
              'contentType': 'application/json;charset=utf-8',
              'data': '{"FTokenID":"'+_this.$store.state.FTokenID+'","FAction":"'+action1+'","'+Guids+'":"'+FVehicleID+'",' +
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":0,"FPageSize":"'+_this.pageSize3+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
              success: function (data) {
                var fobj = data;
                var Baidu= new baidu.baiduAPI();
            ...
            $.ajax({
              ...
              'contentType': 'application/json;charset=utf-8',
              'data': '{"FTokenID":"'+_this.$store.state.FTokenID+'","FAction":"'+action1+'","'+Guids+'":"'+FVehicleID+'",' +
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":1,"FPageSize":"'+_this.pageSize2+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
              success: function (data) {
                var fobj = data;
                var Baidu= new baidu.baiduAPI();
            ...
            $.ajax({
              ...
              'contentType': 'application/json;charset=utf-8',
              'data': '{"FTokenID":"'+_this.$store.state.FTokenID+'","FAction":"'+action+'","'+Guids+'":"'+FVehicleID+'",' +
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":-1,"FPageSize":"'+curpageSize+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
              success: function (data) {
                if(data.Result==104) {
                  _this.$message({
                    showClose: true,
            ...
            $.ajax({
              ...
              'contentType': 'application/json;charset=utf-8',
              'data': '{"FTokenID":"'+_this.$store.state.FTokenID+'","FAction":"'+action1+'","'+Guids+'":"'+FVehicleID+'",' +
              '"FStartTime":"' + startTime + '","FEndTime":"' + endTime + '","FDataType":"6","FState":0,"FPageSize":"'+curpageSize+'","FPageIndex":"'+curpageIndex+'","FSystemType":"'+_this.$store.state.choiceSystemID+'","FVersion":"1.0.0"}',
              success: function (data) {
                if(data.Result==104) {
                  _this.$message({
                    showClose: true,

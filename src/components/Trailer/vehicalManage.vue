<template xmlns:v-popover="http://www.w3.org/1999/xhtml">
	<section style="height: 100%">
					...
					<el-col :span="10">
						<div class='showImage'>
							<el-form-item label="" prop="FImage">
								<el-upload class="avatar-uploader" action="/Web/Common/FileUpload" :show-file-list="false" :on-error='uploadFailed' :before-upload="beforeAvatarUpload"
								 :on-success="handleAvatarSuccess" :data="{FAction:'FileUpload',FVersion:'1.0.0',FTokenID:$store.state.FTokenID}">
						...
						<el-form-item label="_描述_" prop="FDescription">
							<el-input type="textarea" v-model.trim="oneVelData.FDescription" :maxlength="100" :rows="2" placeholder='_最多输入_100_字_'></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<div class='threeinput'>
							<el-form-item label="_公司终端司机_" prop="ce" style='height:82px' label-width="160px">
								<div class='cecontent' @click="focusCompany">
									<div>
										<span style='font-weight:bold'>_所属公司_:</span>{{oneVelData.ce}}</div>
									<div>
										<span style='font-weight:bold'>_关联终端_:</span>{{linkEquipment}}</div>
									<div>
										<span style='font-weight:bold'>_关联司机_:</span>{{linkDriver}}</div>
								</div>
							</el-form-item>
						</div>
						<el-form-item label="_分组_" prop="FGroupGUID" label-width="160px">
				...
				<div class='rightTable'>
					<div class='tableTab' style="height: 100%">
						...
						<div id="operate_wrapper">
							<div class='adminHeader'>
								<div class="float-left">
									<el-button type="primary" class='el-icon-plus' size="small" @click='addDriver'>
									...
									<el-button type="primary" class='el-icon-plus' size="small" @click='batchAdd'>
										<span style="color: white">_批量添加_</span>
									</el-button>
								</div>
						...
						<div id="el_table_wrap" class="el_table_wrap" v-if='activeName==1'>
							...
							<el-table :data="velList" @selection-change="handleSelectionChange1" ref="multipleTable1" :height="table_height" stripe style="width: 100%;"
							 v-loading="loading" element-loading-text="_拼命加载中_...">
								<el-table-column type="selection" width="55"></el-table-column>
								<el-table-column prop="RowNo" label="_序号_" width="80"></el-table-column>
								<el-table-column label="_操作_" width="90">
									<template scope="scope">
										<el-button type="text" size="small" @click="editVel(scope.$index, scope.row)">
										...
										<el-button type="text" size="small" @click="detailV(scope.$index,scope.row)">
						...
						<div id="el_table_wrap" class="el_table_wrap" v-if='activeName==2'>
							<span class='tableTop' v-if=''>{{tableTopName}}</span>
							<el-table :data="velListAll" @selection-change="handleSelectionChange2" ref="multipleTable2" :height="table_height" stripe
		...
		<radio-company :radioCompanyDialog='radioCompanyDialog' v-on:radiochangeC='changeRadioC' v-on:radiochildrenC='radiochildrenC'
		 v-on:radiochildrenE='radiochildrenE' v-on:radiochildrenD='radiochildrenD' :typeTable='typeTable'></radio-company>
	</section>
</template>
<script>
...
<style>
	.batchList .el-table .cell,
	.batchList .el-table th div {
		padding-right: 0;
		padding-left: 0;
	}

<template>
  <div
    class="el-step"
    :style="[styles,  isLast ? '' : { marginRight: - $parent.stepOffset + 'px' }]"
    ...
    <div
      ...
      <div
        ...
        <i class="el-step__line-inner" :style="[lineStyle,width]"></i>
      </div>
...
//   name: 'ElStep',
  ...
  computed: {
    ...
    //   const space = (typeof parent.space === 'number'? parent.space + 'px': parent.space ? parent.space: 100 / (isCenter ? len - 1 : len) + '%');

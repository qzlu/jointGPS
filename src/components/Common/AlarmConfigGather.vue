	    ...
	    <div class='vehical-width'>
			<el-dialog :title="createAlarm?'_新增报警_':'_编辑报警_'" :visible.sync="alarmView" class="addCar-dialog" >
				<el-form :model="ruleForm11" :rules="rules" ref="ruleForm11" label-width="200px" >
					...
					<el-row v-if="SystemID==4||SystemID==2">
						<el-col :span="11">
				            ...
				            <div style='background:white' v-if='treeId'>
				            	<div v-bind:style="{height:table_height + 'px'}" class='overHeight'>
									<el-form :model="ruleFormAll" ref="ruleFormAll" :rules='rules'>
										<div class='overall-config' v-if="SystemID==1||SystemID==2||SystemID==4">
										...
										<div class='overall-config'  v-if="SystemID==1">
										...
										<div class='overall-config'  v-if="SystemID==4||SystemID==2">
				            	...
				            	<div v-bind:style="{height:table_height + 'px'}" class='overHeight container'>
				            	    <div  v-bind:style="{margin:imgHeight + 'px'}" >
				            			...
				            			<div style='height:30px;line-height:30px;font-size:16px;background:#5facfb7a;width:300px;' class='text-center'>
				            			   <i class='el-icon-info'></i><span>_您还没有选择公司哦_</span>
				            			</div>
				            		</div>
				            	</div>
				            </div>
				        ...
				        <div v-if='activeName==2'>
				           <!--  操作按钮 -->
				            ...
				            <div id="el_table_wrap" class="el_table_wrap">
					            <el-table :data="alarmList"  @selection-change="handleSelectionChange1" ref="multipleTable1"
					                ...
					                <el-table-column label="_操作_" prop="operate" width="80">
										<template scope="scope">
											<el-button  type="text" size="small" @click="editAlarm(scope.$index, scope.row)"><i
							class="el-icon-edit" title='_编辑_'></i></el-button>
									...
									<el-table-column width="120"  prop="FTPMSMaxTyre"  label="_高胎压_(bar)" v-if="SystemID==1"></el-table-column>
									<el-table-column width="120"  prop="FTPMSMinTyre"  label="_低胎压_(bar)" v-if="SystemID==1"></el-table-column>
									<el-table-column width="120"  prop="FTPMSMaxTem"  label="_高胎温_(℃)" v-if="SystemID==1"></el-table-column>
									<el-table-column width="120"  prop="FTPMSMinTem"  label="_低胎温_(℃)" v-if="SystemID==1"></el-table-column>
									<el-table-column width="210"  prop="FTPMSTimeLength"  label="_胎温胎压持续时长_(min)" v-if="SystemID==1"></el-table-column>
					                <el-table-column width="120"  prop="FCoolerHightTemperature"  label="_最高温_(℃)" v-if="SystemID==4||SystemID==2"></el-table-column>
					                <el-table-column width="120"  prop="FCoolerLowTemperature"  label="_最低温_(℃)" v-if="SystemID==4||SystemID==2"></el-table-column>
					                <el-table-column width="150"  prop="FCoolerTimeLength"  label="_超温时长_(min)" v-if="SystemID==4||SystemID==2"></el-table-column>
					            </el-table>
				            </div>
				            <!-- 分页 -->
  ...
  export default {
    ...
    methods: {
    	...
    	submitFormAll(formName){       
	        this.$refs[formName].validate((valid) => {
		        if (valid) {
		        	...
		        	let TokenID = this.$store.state.FTokenID;
	                this[formName].FFatigueRunningTimeLength=this[formName].FFatigueRunningTimeLength*60;
	                this[formName].FFatigueRestTimeLength=this[formName].FFatigueRestTimeLength*60;
	                this[formName].FStopCloseACCTimeLength=this[formName].FStopCloseACCTimeLength*60;
	                this[formName].FStopOpenACCTimeLength=this[formName].FStopOpenACCTimeLength*60;
	                this[formName].FOverSpeedTimeLength=this[formName].FOverSpeedTimeLength*60;
	                this[formName].FTPMSTimeLength=this[formName].FTPMSTimeLength*60;
	                this[formName].FCoolerTimeLength=this[formName].FCoolerTimeLength*60;
	                this[formName].FTimeDifferent=this.getTimeZone(this[formName].timeZoneSign,this[formName].hour,this[formName].minute);
	                let dataJson;
	                dataJson=JSON.stringify({FTokenID:TokenID,FAction:"UpdateSystemConfigAlarmAll",FT_SystemConfigAlarm:this[formName],FAgentGUID:FAgentGUID,FVersion:"1.0.0"})
					$.ajax({
						"url": '/web/Common/Common_System',
						"cache": false,
						"async": true,
		...
		submitForm11(formName){
	        ...
	        if(this.createAlarm){
	        	switch(this.SystemID){  /*新增补齐其他系统缺的*/
			    	case 1:
	        ...
	        this.$refs[formName].validate((valid) => {
		        if (valid) {
	                ...
	                this[formName].FTPMSTimeLength=this[formName].FTPMSTimeLength*60;
	                this[formName].FCoolerTimeLength=this[formName].FCoolerTimeLength*60;
	                dataJson=JSON.stringify({FTokenID:TokenID,FAction:"UpdateSystemConfigAlarmVehicle",FT_SystemConfigAlarm:this[formName],FVehicleGUID:FGUID,FVersion:"1.0.0"})
					$.ajax({
						"url": '/web/Common/Common_System',
						"cache": false,
						"async": true,
		...
		doQueryList(index,size,key,id){
			...
			let postData={
				...
				FPageIndex:index,
				FVersion: "1.0.0",
				FSystemType:this.SystemID,  /*应该不要*/
			}
			$.ajax({
				"url": "web/Common/Common_System",
				"cache": false,
